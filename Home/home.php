...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="../INDEX/phone.php">Phones</a>
                <a class="dropdown-item" href="../INDEX/laptop.php">Laptop</a>
                <a class="dropdown-item" href="../INDEX/accessories.php">Accessories</a>
                <a class="dropdown-item" href="../INDEX/gadgets.php">Gadgets</a>
              </div>
            </li>
            <li class="nav-item"><a href="../INDEX/products.php" class="nav-link">Shop</a></li>
            <li class="nav-item"><a href="#" class="nav-link">Contact</a></li>
                  <li class="nav-item"><a href="../C_login.php" class="nav-link">Log Out</a></li>
          </ul>
        </div>
      </div>
    </nav>
  ...
  <section class="veg_section layout_padding">
    <div class="container">
      ...
      <div class="row">
          <?php
        $query = "SELECT * FROM products where Type='Smart Phone' limit 4";
...
if ($result->num_rows > 0) {
        ...
        <div class="col-smd-6 col-md-4 col-lg-3">
          <div class="box box-border-1">
            ...
            <div class="detail-box">
              <a href="../INDEX/product_details.php?id=<?php echo $row['id']; ?>">
                <?php echo $name; ?>
              </a>
              <div class="price_box">
              ...
              <div class="d-grid gap-2 row-1 mx-auto">
                ...
                <div class="col text-center" >
                 ...
                 <a href="../INDEX/product_details.php?id=<?php echo $row['id']; ?>" class="btn btn-danger mt-2">
  ...
  <section class="veg_section layout_padding">
    <div class="container">
      ...
      <div class="row">
          <?php
        $query = "SELECT * FROM products where Type='Laptop' limit 4";
$result = $conn->query($query);
...
if ($result->num_rows > 0) {
      ...
      $qty = $row['qty'];
       $price = $row['price'];
        ...
        <div class="col-smd-6 col-md-4 col-lg-3">
          ...
          <?php } } ?><div class="btn-box">
        <a href="../INDEX/laptop.php">
          View More
        </a>
      </div>
    </div>
  ...
  <section class="veg_section layout_padding">
    <div class="container">
      ...
      <div class="row">
          <?php
        $query = "SELECT * FROM products where Type='Gadget' limit 4";
$result = $conn->query($query);
...
if ($result->num_rows > 0) {
  ...
  <section class="veg_section layout_padding">
    <div class="container">
      ...
      <div class="row">
          <?php
        $query = "SELECT * FROM products where Type='Accessories' limit 4";
$result = $conn->query($query);
