...
if(isset($_POST['submit']) && isset($_POST['id'])){
	...
	$price=$_POST['price'];
	$tex=$_POST['tex'];
	$query ="UPDATE products SET name='".$name."',qty='".$qty."',price='".$price."',
	Tex='".$tex."' WHERE id='".$_POST['id']."'";
...
<body>
	<nav class="navbar navbar-expand-md navbar-dark shadow" style="background-color: #1c2841">
		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item">
					<a class="nav-link" href="insert_product.php">Home<span class="sr-only">(current)</span>
					</a>
				</li>
				<li class="nav-item">
	...
	<div class="container mt-5">
		...
		<div class="row">
			<a href="insert_product.php" class="badge bg-primary text-white ml-auto p-2 mr-5">Add item</a>
          	...
          	<tr>
          		<form method="POST" enctype="multipart/form-data">
          			...
          			<td><input type="text" class="form-control form-control-sm text-danger" name="id"
          				...
          				<td><input type="text" class="form-control form-control-sm text-success" name="qty"
          				value="<?php echo $qty; ?>" disabled></td>
          				<td><input type="text" class="form-control form-control-sm text-success" name="price"
          				value="<?php echo $price; ?>" disabled></td>
          				<td><input type="text" class="form-control form-control-sm text-danger" name="tex"
          				value="<?php echo $tex; ?>" disabled></td>
          				<td>
          					<div class="btn-group">
